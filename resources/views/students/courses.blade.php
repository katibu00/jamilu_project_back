                    ...
                    <div class="card-body">
                        ...
                        @if($courses->isEmpty())
                            <div class="alert alert-info" role="alert">
                                You are not enrolled in any courses. <a href="{{ route('homepage') }}" class="alert-link">Explore our courses</a>.
                            </div>
                        @else
                            <div class="row">
                                @foreach($courses as $course)
                                    <div class="col-lg-4 col-md-6 mb-4">
                                        <div class="card h-100">
                                            <img class="card-img-top" height="300" src="/{{ $course->thumbnail }}" alt="{{ $course->title }}">
                                            <div class="card-body">
                                            ...
                                            <div class="card-footer bg-white">
                                                <a href="{{ route('student.course.show', ['slug' => $course->slug]) }}" class="btn btn-primary btn-block">Go to Learning</a>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
