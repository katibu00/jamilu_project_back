<footer class="bg-gray-800 text-white py-8">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
                <h3 class="text-lg font-semibold mb-4">About Skillify</h3>
                <p class="text-sm">Empowering Nigerians and Africans with world-class education and skills for a brighter future.</p>
            </div>
            <div>
                <h3 class="text-lg font-semibold mb-4">Quick Links</h3>
                <ul class="text-sm space-y-2">
                    <li><a href="#" class="hover:text-blue-400">Courses</a></li>
                    <li><a href="#" class="hover:text-blue-400">Universities</a></li>
                    <li><a href="#" class="hover:text-blue-400">Government Programs</a></li>
                    <li><a href="#" class="hover:text-blue-400">Career Support</a></li>
                </ul>
            </div>
            <div>
