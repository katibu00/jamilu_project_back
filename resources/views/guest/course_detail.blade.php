...
<body class="bg-gray-50 text-gray-800 pb-24">
    <!-- Navigation -->
    <nav
        class="bg-gradient-to-r from-[#1CA664] to-[#3E92CC] text-white p-4 flex justify-between items-center sticky top-0 z-30 shadow-md">
        <div class="flex items-center">
            <button class="mr-3 mobile-tap-target" onclick="window.history.back()">
                <i class="fas fa-arrow-left"></i>
            </button>
            <h1 class="font-bold text-lg truncate">Koyify</h1>
        </div>
        <div class="flex">
    ...
    <div class="fixed bottom-0 left-0 w-full bg-white border-t p-4 flex items-center justify-between z-30">
        ...
        <button class="bg-gradient-to-r from-[#1CA664] to-[#3E92CC] text-white px-6 py-3 rounded-lg font-medium hover:scale-105 transition-transform" onclick="enrollNow()">
            Enroll Now
        </button>
    </div>
